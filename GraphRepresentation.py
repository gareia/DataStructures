...
class Graph(object):
    ...
    def get_edge_list(self):
        ...
        for edge in self.edges:
            item = (edge.value, edge.node_from.value, edge.node_to.value)
    ...
    def get_max_index(self):
        ...
        for node in self.nodes:
            aux_nodes.append(node.value)
            
        return max(aux_nodes)
    ...
    def get_value_from_edge(self, node_from, node_to):
        
        for edge in self.edges:
            if(node_from == edge.node_from.value and node_to == edge.node_to.value):
                return edge.value
        return 0
